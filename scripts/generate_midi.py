...
if __name__ == "__main__":
    ...
    parser.add_argument('--style', type=str, default="Folk", help='音樂風格，目前支援 Modern, Ashanti, Ewe, Funk, Ballad, Reggae, Rock, Disco, Pop, Blues, Jazz, Hiphop, Samba, Tango, Folk')
